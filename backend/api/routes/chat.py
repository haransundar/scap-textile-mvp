...
async def send_message(
    ...
    try:
        ...
        response = "This is a mock response for testing purposes. In a production environment, this would be generated by the LLM service based on your query about GOTS certification."
